...
class RabbitMQConsumer(object):
    ...
    """
    EXCHANGE = rabbitmq_settings['EXCHANGE_NAME']
    EXCHANGE_TYPE = 'topic'
    QUEUE = rabbitmq_settings['EXCHANGE_NAME'] + '-py-queue'
    ROUTING_KEY = ''
    ...
    def __init__(self, amqp_url):
        ...
        self._url = amqp_url
        self._process_message_callback = None
    ...
    def start_consuming(self):
        ...
        # purge all messages before consuming
        self._channel.queue_purge(callback=self.on_queue_purge, queue=self.QUEUE)
        self._consumer_tag = self._channel.basic_consume(self.on_message,
                                                         self.QUEUE)

    def on_queue_purge(self, args):
        log.info('queue has been purged. {0} Messages'.format(args.method.message_count))
        pass
    ...
    def on_message(self, unused_channel, basic_deliver, properties, body):
        ...
        """
        log.info('Received message # %s from %s: ',
                    basic_deliver.delivery_tag, properties.app_id)

        self._process_message_callback(unused_channel, basic_deliver, properties, body)
